...
const Footer = () => {
  ...
  return (
<footer
  className="bg-red sm:text-center md:bg2 text-surface/75  lg:text-left">
    ...
    <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
      ...
      <div className='flex  flex-col  '>
        ...
        <p className="mb-4 flex items-center justify-center md:justify-start">
          ...
          3, Aringar Anna,Co-operative Nagar Darasuram,
          Kumbakonam- 612702
        </p>
        ...
        <p className="mb-4 flex items-center sm:justify-center md:justify-start">
          ...
          <a href="tel:+919942844005" className="hover:underline">
          (+ 91) 99428 44005
          </a>
        </p>
        <a href='https://www.shriworkscraft.com/' target='_blank' className="mb-4 flex items-center hover:underline sm:justify-center md:justify-start">
          <span className="me-3 [&>svg]:h-5 [&>svg]:w-5">
